        ...
        this.auth.update('pages/login', user)
            .subscribe(successCode => {
                ...
                /*  swal({
                      ...
                      html:
                      '<p class="text-muted text-recuperer" align="center">Si vous souhaitez mettre à jour vos données, veuillez confirmer et vous allez vous redirigez vers la page Authentification </p><br>',    
                      type: 'warning',
