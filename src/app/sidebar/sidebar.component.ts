...
export class SidebarComponent implements OnInit {
    ...
    constructor(public authService: AuthControl) {
    ...
    Deconnexion() {
        $.notify({
            icon: "notifications",
            message: "Au revoir Mme ou Mr<b> " + this.currentUser.prenom + " </b> à bientôt."
...
b7:boolean=true;
    ...
    ngOnInit() {
        ...
        if(this.currentUser.type_compte == "ROLE_AgentMarketing"){
            this.b1=false;
            this.b3=false;
            this.b4=false;
            this.b5=false;
            this.b6=false;
        }else if(this.currentUser.type_compte == "ROLE_AgentCommercial"){
            this.b3=false;
            this.b4=false;
            this.b5=false;
            this.b6=false;
        }else if(this.currentUser.type_compte == "ROLE_CommunityManager"){
            this.b1=false;
            this.b2=false;
            this.b3=false;
            this.b5=false;
